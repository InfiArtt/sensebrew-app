...
# First, find the block starting with ListTile for tts_speed up to the end of the tts_voice block
# It ends with `child: Text(settings.ttsVoiceName ?? AppStrings.str(lang, 'tts_voice_default')),` and `),` and `),`
# Just string replace:
old_block = """          ListTile(
