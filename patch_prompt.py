...
old_rules = '''- CRITICAL: For "name", "description", "extraIngredients", and all phase "instructionText", you MUST provide translations in BOTH Indonesian and English using this exact delimiter format: "ID: [Indonesian text] || EN: [English text]". Example: "ID: Gunakan gilingan kasar. || EN: Use a coarse grind."
  ...
  - For "extraIngredients", write cleanly with metric units. DO NOT use acronyms like "sdm" or "SKM". If none, leave blank string "".
  - At the very end of "description", ALWAYS add a new paragraph predicting the flavor profile in both languages.'''

new_rules = '''- CRITICAL: For "name", "description", "extraIngredients", and all phase "instructionText", you MUST provide translations in BOTH Indonesian and English. You must return an object with "id" and "en" keys instead of a string.
  - For "targetGrindSizeMicrons", output an integer. Use 400 (Sangat Halus/Espresso), 600 (Halus/Aeropress), 800 (Sedang/V60), 1000 (Agak Kasar/Chemex), 1200 (Kasar/French Press), or 1400 (Sangat Kasar/Cold Brew).
